...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          data_len = len(replay_buffer.obs)
          ob_batch = replay_buffer.obs[np.random.permutation(data_len)[:batch_size]]
          ac_batch = replay_buffer.acs[np.random.permutation(data_len)[:batch_size]]
